            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-rose-500 rounded-full"></div>
                  <span>
                    Smart background removal with pristine transparent or white
                    backgrounds
                  </span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-rose-500 rounded-full"></div>
                  <span>
                    Professional color grading and uniform lighting enhancement
                  </span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-rose-500 rounded-full"></div>
            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-rose-500 rounded-full"></div>
                  <span>
                    High-resolution outputs with professional formatting options
                  </span>
                </li>
              </ul>
